        ...
        for data in MASTERS_DATA:
            ...
            try:
                ...
                MASTER_WORK_PHOTOS = {
                    ...
                    'Максим Ткаченко': 'denys_tkachenko.png',
                    'Ігор Мельник': 'oleksandr_kovalchuk.png',
                    'Ігор Бондаренко': 'oleksandr_oliynyk.png',
                    'Катерина Кравченко': 'home_team_123.jpg',
                    'Дмитро Шевченко': 'master2.jpg',
                    'Артем Мороз': 'master5.jpg',
                    'Роман Федоренко': 'master3.jpg',
                    'Віталій Гриценко': 'home_team_122.jpg',
                    'Анна Шевчук': 'home_team_130.jpg',
                    'Юрій Лисенко': 'home_team_138.jpg',
                    'Андрій Бондаренко': 'home_team_105.jpg',
                    'Назар Тарасенко': 'andriy_tkachenko.png',
                    'Станіслав Козак': 'home_team_107.jpg',
                    'Денис Білоус': 'home_team_138.jpg',
                    'Олег Сидоренко': 'master5.jpg',
                    'Михайло Павленко': 'home_team_107.jpg',
                    'Євген Захарченко': 'master2.jpg',
                    'Вадим Коваль': 'oleksandr_oliynyk.png',
                    'Марія Петренко': 'home_team_130.jpg',
                    'Ілля Семененко': 'home_team_105.jpg',
                    'Владислав Гончаренко': 'master3.jpg',
                    'Олена Савченко': 'home_team_123.jpg',
                    'Наталія Ковальчук': 'home_team_122.jpg',
                    'Тетяна Бойко': 'home_team_130.jpg',
                }
