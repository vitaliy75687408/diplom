        ...
        for data in MASTERS_DATA:
            ...
            try:
                ...
                MASTER_WORK_PHOTOS = {
                    ...
                    'Ігор Мельник': 'work_117.jpg',
                    'Ігор Бондаренко': 'work_118.jpg',
                    'Дмитро Шевченко': 'work_119.jpg',
                    'Артем Мороз': 'master5.jpg',
                    'Роман Федоренко': 'work_120.jpg',
                    'Віталій Гриценко': 'work_122.jpg',
                    'Юрій Лисенко': 'work_123.jpg',
                    'Андрій Бондаренко': 'Андрій_Бондаренко_work_119.jpg',
                    'Назар Тарасенко': 'andriy_tkachenko.png',
                    'Станіслав Козак': 'work_124.jpg',
                    'Денис Білоус': 'work_126.jpg',
                    'Олег Сидоренко': 'work_127.jpg',
                    'Михайло Павленко': 'work_137.jpg',
                    'Євген Захарченко': 'work_138.jpg',
                    'Вадим Коваль': 'work_139.jpg',
                    'Ілля Семененко': 'work_139.jpg',
                    'Владислав Гончаренко': 'master3.jpg',
                    'Сергій Кравцов': 'master2.jpg',
                    # Жінки
                    'Катерина Кравченко': 'work_121.jpg',
                    'Анна Шевчук': 'work_125.jpg',
                    'Марія Петренко': 'work_128.jpg',
                    'Олена Савченко': 'work_135.jpg',
                    'Наталія Ковальчук': 'work_136.jpg',
                    'Тетяна Бойко': 'work_140.jpg',
                }
