        ...
        for data in MASTERS_DATA:
            ...
            try:
                ...
                MASTER_WORK_PHOTOS = {
                    ...
                    'Максим Ткаченко': 'Максим_Ткаченко_work_137.jpg',
                    'Ігор Мельник': 'Ігор_Мельник_work_139.jpg',
                    'Катерина Кравченко': 'Катерина_Кравченко_work_132.jpg',
                    'Дмитро Шевченко': 'Дмитро_Шевченко_work_138.jpg',
                    'Артем Мороз': 'Артем_Мороз_work_134.jpg',
                    'Роман Федоренко': 'Роман_Федоренко_work_115.jpg',
                    'Віталій Гриценко': 'Віталій_Гриценко_work_118.jpg',
                    'Анна Шевчук': 'Анна_Шевчук_work_117.jpg',
                    'Юрій Лисенко': 'Юрій_Лисенко_work_111.jpg',
                    'Андрій Бондаренко': 'Андрій_Бондаренко_work_120.jpg',
                    'Назар Тарасенко': 'Назар_Тарасенко_work_112.jpg',
                    'Станіслав Козак': 'Станіслав_Козак_work_125.jpg',
                    'Денис Білоус': 'Денис_Білоус_work_114.jpg',
                }
